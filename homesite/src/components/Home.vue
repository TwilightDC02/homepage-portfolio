  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center px-4">
    <div class="max-w-4xl w-full text-center space-y-8">
      ...
      <div class="inline-flex items-center gap-2 px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
        ...
        <span class="text-white text-sm font-medium">Portfolio Coming Soon</span>
      </div>

      <!-- Description -->
      <p class="text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed">
        Building amazing web experiences with Vue.js, Node.js, and modern technologies.
      ...
      <div class="flex items-center justify-center gap-6 pt-4">
        <a 
          href="https://github.com/justinbondc" 
          target="_blank"
        ...
        <a 
          href="https://linkedin.com/in/justinbondc" 
          target="_blank"
          rel="noopener noreferrer"
          class="text-gray-400 hover:text-white transition-colors duration-300"
          aria-label="LinkedIn"
        ...
        <a 
          href="mailto:justin@justinbondc.com" 
          class="text-gray-400 hover:text-white transition-colors duration-300"
          aria-label="Email"
        >
      ...
      <!-- Current Project Link (Optional) -->
      <div class="pt-8">
        <a 
          href="https://feedmeai.tech" 
          target="_blank"
          rel="noopener noreferrer"
        ...
        >
          <span>View My Latest Project</span>
      ...
      <div class="pt-12">
        <p class="text-gray-500 text-sm">
          © 2025 Justin Bon Dela Cruz. All rights reserved.
        </p>
      </div>
    </div>
  </div>
...
<script setup>
// No state needed for this simple page
// You can add more interactivity later if needed
</script>
